...
$sql="select p.id_producto,d.descripcion,p.diseno,p.materiales,d.numero_compra,d.cant_ingreso,d.precio_compra,d.precio_venta from productos as p inner join detalle_compras as d on p.id_producto=d.id_producto  where p.id_producto=? and d.numero_compra=? and cant_ingreso>0;";
$sql=$conectar->prepare($sql);
