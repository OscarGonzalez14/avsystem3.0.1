  ...
  <div class="form-row">
    ...
    <div style="margin-left:5px;margin-right:5px" class="form-group col-sm-2">
      <label for="fecha_inicial">Desde</label>
        <input type="date" class="form-control float-right rango-date" id="fecha_inicial" onClick="rango_date();">
    </div>
    
    <div style="margin-left:5px;margin-right:5px" class="form-group col-sm-2">
        <label for="fecha_final">Hasta</label>
        <input type="date" class="form-control float-right rango-date" id="fecha_final" onClick="rango_date();">
    </div>


    <div class="form-group col-sm-2">
      <label for="sucursal_vtas_mensual">Sucursal</label>
      <select id="sucursal_vtas_mensual" class="form-control">
    ...
    <div style="margin-left:5px;margin-right:5px" class="form-group col-sm-2">
      ...
      <table id="data_vtas_mensuales" width="100%" style="text-align: center;text-align:center" data-order='[[ 0, "desc" ]]' class="table-hover table-bordered">
...
<input type="hidden" id="name_page" value="MODULO VENTAS">
