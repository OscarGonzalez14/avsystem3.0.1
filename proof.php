...
<div class="invoice p-3 mb-3">
           ...
           <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="dropdown dropright col-sm-6" id="comprobantes_cancelacion">
                <button class="btn btn-primary dropdown-toggle" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-print"></i> Comprobante de Cancelación
                </button>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="background-color: #33AFFF">
                  <a class="dropdown-item" href="#" id="print_factura"><button class="btn btn-secondary btn-block"  onClick="print_facturas_ventas()"></i> Imprimir Factura</button></a>
                  <a class="dropdown-item" href="#" id="print_credito_fiscal"><button class="btn btn-secondary btn-block" onClick="print_cff_ventas()"></i> Imprimir Credito Fiscal</button></a>
                </div>
              </div>
