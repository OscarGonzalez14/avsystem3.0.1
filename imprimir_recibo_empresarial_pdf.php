...
$datos_factura_cantidad = $reporteria->get_datos_factura_cantidad($numero_venta,$id_paciente_oc);
$datos_factura_producto = $reporteria->get_datos_factura($numero_venta,$id_paciente_oc);
$datos_factura_precio_u = $reporteria->get_datos_factura_p_unitario($numero_venta,$id_paciente_oc);
$datos_factura_subtotal = $reporteria->get_datos_factura_subtotal($numero_venta,$id_paciente_oc);
$datos_factura_paciente = $reporteria->get_datos_factura_paciente($id_paciente_oc);
$datos_factura_venta    = $reporteria->get_datos_factura_venta($numero_venta,$id_paciente_oc);

$datos_recibo = $reporteria->print_recibo_paciente($numero_rec_oc,$numero_venta,$id_paciente_oc);
?>
...
<table style="width:95%;">
 ...
 <tr>
  ...
  <tr>
    <td style="text-align:center; font-size:11px;font-family: Helvetica, Arial, sans-serif;"><span><strong>Telefono:</strong> <?php echo $telefono;?>&nbsp;&nbsp;&nbsp;</span><span><strong>Whatsapp:</strong> <?php echo $wha;?>&nbsp;&nbsp;&nbsp;<br></span>E-mail;&nbsp;<?php echo "metrocentro@opticaavplussv.com";?></td>
  </tr>
...
<table>
  ...
  <tr>
    <td style="color:red;text-align:right; font-size:14px"><strong >No.&nbsp;<span><?php echo $numero_rec_oc;?></strong></td>
  </tr>
...
<tr style="font-size:10pt" class="even_row">
    ...
    <td style="text-align: center;width: 22%" colspan="22" class="stilot1"><span class=""><?php echo "$-";?></span></td>
