...
<div class="modal fade bd-example-modal-lg" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="modal_recibos_generico" style="border-radius:0px !important;">
  <div class="modal-dialog modal-lg" role="document" id="tamModal_abonosg">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" id="telefono_abono_e" readonly="" style="background: white">
    </div>
  ...
  <div class="modal-footer">
    <button class="btn btn-primary btn-block" onClick="registra_abonos()" id="registrar_abono"><i class="fa fa-save"></i>  Registrar Abono</button>         
    <button class="btn btn-primary btn-block" onClick="registra_abonos();" id="edit_abono"><i class="fa fa-save"></i> Guardar Cambios</button>
  </div>
