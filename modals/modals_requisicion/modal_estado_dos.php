        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header bg-info" style="color:white">
              <h4 class="modal-title">REQUISICIÓN&nbsp;&nbsp;#<span id="n_requisicion"></span></h4>
            ...
            <table id="lista_aros_ventas_data" width="100%" class="table-hover table-bordered">
              <thead style="background:#034f84;color:white;text-align: center;">
                <tr>
                  <th style="width: 50% !important">Descripcion</th>
                  <th style="width: 10% !important">Cantidad</th>
                  <th style="width: 15%">Precio</th>
                  <th style="width: 25% !important">#Ticket</th>
                </tr>
              </thead>
              ...
              <tfoot>
                <tr>
                  <th style="width: 70% !important;text-align: center">Total</th>
                  <th style="width: 15%"></th>
                  <th style="width: 15%"><span>$</span><span id="total_caja"></span></th>
                </tr>
              </tfoot>
            </table>
          </div>
