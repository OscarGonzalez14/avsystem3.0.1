    ...
    <div class="modal-dialog modal-lg" id="tanModal">
      ...
      <div class="modal-content" >
        <div class="modal-header" id="head" style="justify-content: space-between">
          <span><i class="fas fa-plus-square"></i> CREAR MARCA</span>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary btn-block" data-dismiss="modal" style="border-radius:0px" onClick="guardarMarca();" ><i class="fas fa-save"></i> Guardar</button>
        </div>
      </div>
    </div>
  </div>
